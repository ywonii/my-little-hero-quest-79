      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            ...
            문해력 난이도 가이드(문장 복잡도 규칙):
            - 하(초1): 1문장, 4~6어절, 연결어/종속절 없음, 단순 동사 사용.
              예) "친구와 놀았어요"
            - 중(초1-2): 1문장, 7~11어절, 장소/시간 수식어 1개 포함 가능, 단순 연결어 1개 이내.
              예) "나는 친구와 같이 놀이터에서 놀았어요"
            - 상(초2): 정확히 2문장, 총 12~18어절, 시간/장소 + 부사 1개 + 이유/배경 1개까지 허용. 문장 수는 반드시 2.
              예) "학교가 끝난 뒤, 나는 친구와 놀이터에서 신나게 놀았어요. 집에 가기 전이라서 더 신났어요."

            금지 사항(모든 레벨 공통):
            - '이러한 복잡한 상황에서', '가장 적절한 대응 방법을 선택해야 합니다' 같은 메타 문장/해설 문구 사용 금지.
            - 제목에 불필요한 접미어/부제(예: ' - 상황 분석 및 해결 방안') 추가 금지.
